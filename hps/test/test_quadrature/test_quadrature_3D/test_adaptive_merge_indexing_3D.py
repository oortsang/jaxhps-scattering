...
class Test_get_rearrange_indices:
    ...
    def test_1(self) -> None:
        ...
        2. Generate quadratures of all eight sub-cubes using _corners_for_oct_subdivision and corners_to_gauss_points_lst.
        ...
        # Step 1:
        gauss_pts = get_all_boundary_gauss_legendre_points(q, root)

        # Step 2:
        oct_corners = _corners_for_oct_subdivision(corners)
        quad_pts_lst = [
            corners_to_gauss_points_lst(q, corners) for corners in oct_corners
        ]
    ...
    # @pytest.mark.skip("TODO 3D")
    def test_2(self) -> None:
        """This function tests that the get_rearrange_indices function successfully rearranges the indices in the non-uniform refinement case.
        Steps:
        1. Generate a quadrature of a cube with l=1 using get_all_boundary_gauss_legendre_points.
        ...
        for child in root.children:
            quad_pts = get_all_boundary_gauss_legendre_points(q, child)
